...
cox_output_time_dependent_cov <- function(data, time1, time2, status, vars, fixed.var = NULL, output = "table",  modeltype = "full", p.thres = 0.1, niter = 10, weights = NULL){
  ...
  formula <- paste("Surv(",time1,", ",time2, ",", status,") ~ ", vars_input, sep = "")
